...
echo --- building CommandBarDemo.exe ---
"%MSBUILD%" CommandBarDemo.cwproj /p:ClarionBinPath=%CLARIONBIN% /v:minimal || goto :failed
...
echo.
echo Build OK - run CommandBarDemo.exe from this folder.
endlocal & exit /b 0
