...
echo --- building CommandBarShowcase.exe ---
"%MSBUILD%" CommandBarShowcase.cwproj /p:ClarionBinPath=%CLARIONBIN% /v:minimal || goto :failed
...
echo.
echo Build OK - run CommandBarShowcase.exe from this folder.
endlocal & exit /b 0
